 ...
 * Sets the format in which images are processed
 * 
 ...
 * @default : "_"
 * Defines the separator character to use in the name of the processed image.
 * The processed image name is composed of the original name followed by its width and its height.
 * If the separator character is used in the original name, it's simply removed.
 * @examples: 
 *    my-image => my-image_400_300, my-image_800_600, my-image_1200_900...
 *    my_image => myimage_400_300, myimage_800_600, myimage_1200_900...
 * 
 ...
 * @default : false
 * If true, square thumbnails will be generated with default settings.
